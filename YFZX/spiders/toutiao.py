...
class chinadaily(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        # while True:
        for url in urls:
            yield scrapy.Request(url=url,headers=headers,cookies={},meta={'plant_form':'None','isIndex_request':True},dont_filter=True)
        yield scrapy.Request(url='https://www.toutiao.com/api/pc/feed/?category=%E7%BB%84%E5%9B%BE&utm_source=toutiao&as=A1F5F9655ABFB36&cp=595A5F6BB3262E1',headers=headers,cookies={},meta={'plant_form':'None','isIndex_request':True},dont_filter=True)
            # time.sleep(20)
